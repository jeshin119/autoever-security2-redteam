...
import { 
  FiArrowLeft, FiHeart, FiShare2, FiMessageCircle, 
...
const ProductDetailPage = () => {
    ...
    try {
      ...
      if (response.data && response.data.success) {
        ...
        const enrichedProduct = {
          ...productData,
          sellerName: productData.seller?.name || '익명 사용자',
          sellerRating: productData.seller?.mannerScore || 36.5,
          sellerPhone: productData.sellerPhone || productData.seller?.phone,
  ...
  const handleChatStart = () => {
    ...
    navigate(`/chat?product=${id}&seller=${product.userId}`);
  };
        ...
        <InfoSection>
          ...
          <ActionButtons>
            <PrimaryButton 
              ...
              disabled={product.status === 'sold' || (user && user.id === product.userId)}
            >
              <FiMessageCircle />
        ...
        <RelatedSection>
          ...
          <RelatedGrid>
            {relatedProducts.map(relatedProduct => (
              ...
              >
                <RelatedProductImage 
                  image={getImageUrl(relatedProduct.images?.[0])}
                />
                <RelatedProductInfo>
